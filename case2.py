# https://irhum.github.io/blog/pjit/#case-2-outer-axes
import os
...
B = jax.device_put(B, sharding.replicate(axis=1, keepdims=True))
print("visualize B: ")
...
assert C_0.shape == (2,4)
print("C_0.shape: ", C_0.shape)
# In this case, not all devices will have a copy of C, since A was completely
# sharded across X and Y axis, but we still have some duplicates because B
# was replicated across the Y axis.
